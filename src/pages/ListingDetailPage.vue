<template>
  <div class="min-h-screen bg-[#F8FAFF] pt-20">
    ...
    <div v-else class="max-w-2xl mx-auto px-4 py-8">
      ...
      <!-- Back -->
      <button @click="router.back()" class="flex items-center gap-2 text-gray-500 hover:text-[#010f6b] mb-6 transition-colors text-sm">
      ...
      <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <!-- Image header -->
        <div class="relative h-56 flex-shrink-0" :style="{ background: listing.gradient }">
        ...
        <div class="p-6">
          ...
          <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl mb-5">
            <div class="w-12 h-12 bg-[#010f6b] rounded-full flex items-center justify-center text-white font-bold text-lg">M</div>
            <div class="flex-1">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <button class="btn-primary text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2">
