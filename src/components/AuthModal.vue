          ...
          <div class="p-6">
            ...
            <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="space-y-4">
              ...
              <button type="button" @click="handleSocialLogin('google')" :disabled="socialLoading"
                      class="w-full flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors disabled:opacity-60">
